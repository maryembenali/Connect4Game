...
public class gui extends JFrame {
	  private final Container cp;
	    ...
	    public void rungame(boolean player1turn, connect4 game, int rows, int columns) {
	    	  for(int row = 0; row < rows; row++) {
		            for (int col = 0; col < columns; col++) {
	    ...
	    public void image (boolean player1turn, connect4 game, int rows, int columns)
	    {   // Prepare Icons
	    ...
	    public gui(boolean player1turn, connect4 game, int rows, int columns) {
	        this.game = game;
	        this.rows = rows;
	        this.columns = columns;
	        fenetre window;
	       /* JFrame frame = new JFrame("welcome to our game connect4 !");
	      ...
	      image(player1turn,  game, rows, columns);
	         
	        rungame( player1turn,  game,  rows,  columns);
